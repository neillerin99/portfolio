...
export default function Hero() {
  return (
    <section className="h-screen bg-[radial-gradient(circle_at_left,_#1E3A8A_0%,_#000000_60%)] text-white flex sm:flex-row flex-col items-center justify-between">
      <div className="flex flex-col basis-1/2 items-center justify-center text-center">
